...
function decode(payload, metadata) {
    ...
    res.id = "odor-sensor:" + sensorId+"-milesight";
    res.type=  "odor-sensor"
    let rawPayload = base64ToHex(payload.data);
    let decoded = Decoder(payload.fPort, getHex(rawPayload) );
